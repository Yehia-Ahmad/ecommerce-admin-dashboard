...
const LEGACY_DIST_CANDIDATES = [
  path.join(DIST_ROOT, 'ecommerce-admin-dashboard-v2', 'browser'),
  path.join(DIST_ROOT, 'ecommerce-admin-dashboard-v2'),
  path.join(DIST_ROOT, 'ecommerce-admin-dashboard', 'browser'),
  path.join(DIST_ROOT, 'ecommerce-admin-dashboard'),
];
