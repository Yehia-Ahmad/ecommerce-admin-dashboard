    ...
    <main class="invoice-sheet">
      <section class="invoice-body">
        <header class="invoice-header">
          <div class="logo-box">
            <img src="${logoUrl}" alt="Ecommerce Admin Dashboard logo" />
          </div>

          <div class="company-heading">
            <h1 class="company-name">Ecommerce Admin Dashboard</h1>
...
function getCreditInvoiceLabels(language: CreditInvoicePrintLanguage): CreditInvoiceDocumentLabels {
  if (language === 'ar') {
    return {
      ...
      companyMeta: 'سجل فاتورة بيع آجل صادر من نظام Ecommerce Admin Dashboard',
  ...
  return {
    ...
    companyMeta: 'Credit-sales invoice generated from the Ecommerce Admin Dashboard system',
    ...
    tableTotal: 'Total',
    footerNote: 'This credit invoice was generated electronically from the Ecommerce Admin Dashboard system.'
  };
}
