...
function getInvoiceLabels(language: InvoicePrintLanguage): InvoiceDocumentLabels {
  if (language === 'ar') {
    return {
      ...
      companyMeta: 'سجل فاتورة مبيعات صادر من نظام Ecommerce Admin Dashboard',
  ...
  return {
    ...
    companyMeta: 'Sales invoice generated from the Ecommerce Admin Dashboard system',
    ...
    tableTotal: 'Total',
    invoiceNote: 'This invoice was generated electronically from the Ecommerce Admin Dashboard system.'
  };
}
